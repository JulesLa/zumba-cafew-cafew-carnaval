function init()
{
    ...
    ennemies = [new Ennemy("ennemy1", 0xff0000, new THREE.Vector2(-70, 0), 0), new Ennemy("ennemy2", 0xff0000, new THREE.Vector2(70, 0), 0)]
    ennemies.forEach(ennemy => scene.add(ennemy.graphic))
